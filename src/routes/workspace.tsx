    ...
    return (
        <div className="h-fit w-full px-6 py-3">
            <div className="mb-6 flex flex-wrap gap-4 max-[1200px]:flex-col">
                <div className="max-h-[200px] flex-1 overflow-hidden rounded-lg border border-neutral-600 max-[900px]:hidden">
                    <Gif />
                </div>
                <div className="flex flex-1 gap-4 max-[800px]:flex-col">
                    ...
                    <div className="max-h-[200px] flex-1 rounded-lg border-1 border-neutral-600 max-[300px]:w-full">
                        <PomodoroTimer />
                    </div>
                </div>
            </div>
